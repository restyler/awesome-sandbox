...
| [**Declaw** ↓](#49-other-notable-platforms--cloud-development-environments-cdes) | Firecracker (MicroVM) | 2026 | N/A | Apache-2.0 (SDKs & CLI); platform commercial | Yes (Terraform, AWS) | Yes | Persistent | Full (configurable egress filtering) | Short & Long-Running |
